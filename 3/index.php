...
$integration
    ...
    ->addProvider(new \Leadrock\Providers\Leadrock('2304', '15f68e8ce794d6fae480df83073b598f'))
    ->setWebmasterLinkFromParam('track_url')// если интегрирою на какого либо веб мастера то переиминовываем метод в setWebmasterLink и добавляем вместо ('track_url')
    ...
    // если нужно вставить пиксель то убираем метод ->findFrom('fbpixel') и вставляем номер пикселя в FacebookPixel()) в одинарных ковычках
    ->disableProxy()
;
